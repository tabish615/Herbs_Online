        ...
        return (
            <div style={{ position: "absolute", top: "15%", display: "flex", width: "100%", marginTop: "5%" }}>
                <div style={{ width: "50%", height: "100%", display: "flex", justifyContent: "center", paddingLeft: "5%" }}>
                    <img src={this.props.location.state && this.props.location.state.herbData.Image} style={{ height: "50vh", width: "40vw" }} />
                </div>
                ...
                <div style={{ textAlign: "center", width: "50%", paddingRight: "10%", paddingLeft: "10%" }}>
                    <Typography variant="h3" component="h2" gutterBottom align="left">
                        {this.props.location.state && this.props.location.state.herbData.English_Name} ({this.props.location.state.herbData.Roman_Name})
                    </Typography>
                    <Typography variant="h3" component="h2" gutterBottom align="right" >
                        {this.props.location.state && this.props.location.state.herbData.Urdu_Name}
                    </Typography>
                    <Typography variant="h4" component="h2" gutterBottom align="left" >
                        Rs. {this.props.location.state && this.props.location.state.herbData.Price * this.state.quantity}
                    </Typography><br /><br />
                    <Typography variant="h4" component="h2" gutterBottom align="left" >
                        Form:
                    </Typography>
                    ...
                    <Button variant="outlined" size="medium" style={{ textTransform: "lowercase", float: "left",  fontSize: "15px" }}>
                        {this.props.location.state && this.props.location.state.herbData.MOQ_Gram * this.state.quantity} gm
                    </Button><br /><br /><br /><br />
